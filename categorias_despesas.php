  ...
  <div class="ls-sidebar-inner">
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        <h1 class="ls-title-intro ls-ico-home">Categorias - Despesas</h1>
...
if (isset($_REQUEST["situacao_add"]) == "1")
{
  ...
  $obj= new Database;
  $resultado = $obj->connect("select * from categoria order by DESC_CATEGORIA asc");
...
<div class="ls-box ls-board-box">
  ...
  <header class="ls-info-header">
    <p class="ls-float-right ls-float-none-xs"> <button  data-ls-module="modal" data-action="lib/insere_categorias_despesas.php"  data-content="
    ...
    <h2 class="ls-title-3">Lista das Categorias de Despesas</h2>
  </header>
  ...
  while($linha=mysqli_fetch_array($resultado))
   {
    ...
    <tr>
      ...
      <td>
        <button data-ls-module='modal' data-action='lib/exclui_categorias_despesas.php?id=$id' data-content='<h2>Tem certeza da exclusão deste registro?</h2><p>O registro não poderá ser restaurado após esse procedimento.</p>' data-title='Excluir registro' data-class='ls-btn-primary' data-save='Excluir' data-close='Fechar' class='ls-btn-primary ls-btn-xs'>Excluir</button>
      </td>
      <td></td>
    </tr>";
  }
