  ...
  <aside class="ls-sidebar">
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        <h1 class="ls-title-intro ls-ico-cog">Configuração Geral</h1>

<div class="ls-alert-box ls-dismissable">
  <header class="ls-info-header">
    <span data-ls-module="dismiss" class="ls-dismiss">&times;</span>
    <h2 class="ls-title-3">Serviços</h2>
  ...
  <h3 class="ls-title-5">Usuários</h3>
  
 <table class="ls-table ls-table-striped">
    <tbody>
      <tr>
        <td><strong>Habilitar<i> "Esqueci minha Senha": </i> </strong> 
          <div data-ls-module="switchButton" class="ls-switch-btn ls-float-right"> <input type="checkbox" id="teste">
          <label class="ls-switch-label" for="teste" name="label-teste" ls-switch-off="Desativado" ls-switch-on="Ativado"><span></span></label>
          </div>
        </td>
      ...
      <tr>
        <td><strong>Próprio usuário pode criar sua conta: </strong> 
          <div data-ls-module="switchButton" class="ls-switch-btn ls-float-right"> <input type="checkbox" id="teste">
          <label class="ls-switch-label" for="teste" name="label-teste" ls-switch-off="Desativado" ls-switch-on="Ativado"><span></span></label>
          </div>
        </td>
    ...
    <tr>
        <td><strong>Habilitar autenticação via google: </strong> 
          <div data-ls-module="switchButton" class="ls-switch-btn ls-float-right"> <input type="checkbox" id="teste">
          <label class="ls-switch-label" for="teste" name="label-teste" ls-switch-off="Desativado" ls-switch-on="Ativado"><span></span></label>
          </div>
        </td>
        ...
        <tr>
        <td><strong>Habilitar autenticação via Facebbok: </strong> 
          <div data-ls-module="switchButton" class="ls-switch-btn ls-float-right"> <input type="checkbox" id="teste">
          <label class="ls-switch-label" for="teste" name="label-teste" ls-switch-off="Desativado" ls-switch-on="Ativado"><span></span></label>
          </div>
        </td>
