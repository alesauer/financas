  ...
  <div class="ls-sidebar-inner">
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <p>Oi, <b><?php echo $_SESSION['login'];?> </b>. Bem-vindo à sua área. Você já acessou esse sistema <b><?php echo $_SESSION['cont_acesso']; ?></b> vezes. Seu último acesso foi: <b><?php echo $_SESSION['ultimo_acesso'];?> </b>. </p>
<?php
...
{
$mensagem=$_REQUEST["mensagem"];  
echo "<div class='ls-alert-success'><strong>Sucesso!</strong> $mensagem</div>";
}

if(isset($_REQUEST["situacao"]) == "2" ){
$mensagem=$_REQUEST["mensagem"];  
echo "<div class='ls-alert-danger'><strong>Erro!</strong> $mensagem</div>";
}

if (isset($_REQUEST["situacao"]) == "3" ){
$mensagem=$_REQUEST["mensagem"];  
echo "<div class='ls-alert-danger'><strong>Erro!</strong> $mensagem</div>";
}
*/
...
?>
  ...
  <p class="ls-float-right ls-float-none-xs"> <button  data-ls-module="modal" data-action="lib/trocasenha.php"  data-content="
  <fieldset>
...
<?php
  ...
  $resultado = $obj->connect("select * from usuario where COD_Usuario='$cod_usuario'");
...
<br>
<br>
  <form action="lib/altera_dados_user.php" method="post" class="ls-form row" data-ls-module="form">
